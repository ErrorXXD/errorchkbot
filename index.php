...
$botToken = "7004339588:AAF2oI1Xbw5DIO-btuib8zddjMIWyU9Vo9k";
...
$emojid = '❌';
$emojil = '✅';
$owner = '<code>@CallmeluckyxD</code>';
$botu = " ϟ 𝘽𝙊𝙏 𝘽𝙔  ϟ @LVXKY";
$bota = "<b> ϟ DEV  ϟ  @LVXKY</b>";$eror = "<b>Error ❌</b>";
...
if ($cdata2 == "back2") {
    $gatesText = "𝘿𝙊𝙉𝙀 𝙀𝙓𝙋𝙇𝙊𝙍𝙄𝙉𝙂 𝙈𝙔 𝙈𝙀𝙉𝙐 ?
...
$keyboard = json_encode([
    'inline_keyboard' => [
        [
            ['text' => " ϟ 𝘽𝙐𝙔 𝙋𝙍𝙀𝙈𝙄𝙐𝙈 𝙉𝙊𝙒 ϟ  ", 'url' => "t.me/callmeluckyxD"],
        ],
    ]
]);
...
$channel = json_encode([
    'inline_keyboard' => [
        [['text' => "𝕮𝖍𝖆𝖓𝖓𝖊𝖑", 'url' => "t.me/LVXKY"], ['text' => "𝕲𝖗𝖔𝖚𝖕", 'url' => "t.me/LVXKYCHAT"]],
        [['text' => "𝕭𝖆𝖈𝖐 ", 'callback_data' => 'back2']]
    ]
]);
...
//==========back and close========//
if ($cdata2 == "back2") {
    $backtxt = ("𝘿𝙊𝙉𝙀 𝙀𝙓𝙋𝙇𝙊𝙍𝙄𝙉𝙂 𝙈𝙔 𝙈𝙀𝙉𝙐 ?
𝙎𝙊 𝙒𝙃𝙔 𝘼𝙍𝙒 𝙔𝙊𝙐 𝙒𝘼𝙄𝙏𝙄𝙉𝙂 𝙁𝙊𝙍 𝙋𝙐𝙍𝘾𝙃𝘼𝙎𝙀 𝙋𝙍𝙀𝙈𝙄𝙐𝙈 𝙉𝙊𝙒 𝘾𝙊𝙉𝙏𝘼𝘾𝙏 @callmeluckyxD 
");

    // Change this to your video url
    $backVideoUrl = "https://t.me/lvxkychat/2426"; 
