...
$botToken = "6675180234:AAH-SzVKCQzmsSDyDJA-M0Ne5Kjc7rpPfKc";
...
$botu = "𝐁𝐨𝐭 𝐁𝐲 ↯ @ERR0R9";
$bota = "<b>|×| DEV ↯ @ERR0R9</b>";$eror = "<b>Error ❌</b>";
...
𝙒𝙚𝙡𝙡 𝘽𝙚𝙛𝙤𝙧𝙚 𝙂𝙤𝙞𝙣𝙜 𝙂𝙚𝙩 𝙈𝙚 𝙈𝙮 𝙊𝙣𝙚 𝙁𝙞𝙣𝙜𝙚𝙧 𝘽𝙮 @ERR0R9";
...
⚠️ 𝘛𝘏𝘐𝘚 𝘛𝘖𝘗-𝘜𝘗 𝘈𝘙𝘌 𝘕𝘖𝘕 𝘙𝘌𝘍𝘜𝘕𝘋𝘈𝘉𝘓𝘌 ⚠️";
                                 ...
                                 $gatesKeyboard = json_encode([
                                 'inline_keyboard' => [
                                     [                     ['text' => 'ᴄᴏɴꜰɪʀᴍ ᴘᴀʏᴍᴇɴᴛ', 'url' => '@ERR0R9'],   ], ]
  ]);
...
$keyboard = json_encode([
    'inline_keyboard' => [
        [
            ['text' => "↯ 𝙂𝙚𝙩 𝙀𝙍𝙍𝙊𝙍 𝘾𝙃𝙀𝘾𝙆𝙀𝙍 𝙋𝙧𝙚𝙢𝙞𝙪𝙢 ↯", 'url' => "t.me/ERR0R9"],
        ],
    ]
]);
...
if ($cdata2 == "back") {
    ...
    $gatesText = "<b>𖤐 𝙂𝘼𝙏𝙀𝙒𝘼𝙔𝙎 𖤐 

- - - - - - - - - - - - 
× 𝐂𝐡𝐚𝐫𝐠𝐞 𝐆𝐚𝐭𝐞𝐰𝐚𝐲 : <code>20</code>
× 𝐀𝐮𝐭𝐡 𝐆𝐚𝐭𝐞𝐰𝐚𝐲 : <code>6</code>
× 𝚃𝚘𝚝𝚊𝚕 : <code>26</code>
- - - - - - - - - - - - 
...
$bota</b>";
    ...
    $gatesKeyboard = json_encode([
        'inline_keyboard' => [
            [['text' => "𝐀𝐮𝐭𝐡 𝐆𝐚𝐭𝐞𝐰𝐚𝐲'𝐬", 'callback_data' => 'premium'], ['text' => "𝐂𝐡𝐚𝐫𝐠𝐞 𝐆𝐚𝐭𝐞𝐰𝐚𝐲'𝐬", 'callback_data' => 'free']],
            [['text' => '𝙱𝙰𝙲𝙺', 'callback_data' => 'back2']]
        ]
    ]);
    $videoUrl = "https://t.me/BR0KENxCC/6";
...
$channel = json_encode([
    'inline_keyboard' => [
        [['text' => "𝕮𝖍𝖆𝖓𝖓𝖊𝖑", 'url' => "t.me/ERROR_EMPIRE"], ['text' => "𝕲𝖗𝖔𝖚𝖕", 'url' => "t.me/ERROR_EMPIRE"]],
        [['text' => "𝕭𝖆𝖈𝖐 ", 'callback_data' => 'back2']]
    ]
]);
