...
$c4 = substr($cc, -4);
    ...
    if (empty($cc) || empty($cvv) || empty($mes) || empty($ano)) {
        bot('editMessageText', [
            ...
            'text' => "!𝙒𝙍𝙊𝙉𝙂 𝙁𝙊𝙍𝙈𝘼𝙏!\n𝘾𝙊𝙍𝙍𝙀𝘾𝙏 𝙁𝙊𝙍𝙈𝘼𝙏 𝙄𝙎 - <code>$gcm cc|mm|yy|cvv</code>\n𝙂𝙖𝙩𝙚𝙬𝙖𝙮 - <b>$gate</b>",
            'parse_mode' => 'html',
  ...
  bot('editMessageText', [
          ...
          'text' => "<b>[〄] 𝙋𝙍𝙊𝙂𝙍𝙀𝙎𝙎 - ■□□□
- - - - - - - - - - - - - - - - - - -
[〄] 𝘾𝙖𝙧𝙙  ϟ <code>$lista</code>
[〄] 𝙂𝘼𝙏𝙀𝙒𝘼𝙔  ϟ $gate
[〄] 𝘽𝙖𝙣𝙠  ϟ $bank
[〄] 𝙏𝙮𝙥𝙚 ϟ $bininfo
[〄] 𝘾𝙤𝙪𝙣𝙩𝙧𝙮 ϟ $country
- - - - - - - - - - - - - - - - - - -
[〄] 𝙈𝘼𝙓𝙄𝙈𝙐𝙈 𝙏𝙄𝙈𝙀 ϟ 25 𝙎𝙀𝘾
[〄] 𝙍𝙀𝙌 𝘽𝙔 ϟ @$username</b>",
        'parse_mode' => 'html',
          'disable_web_page_preview' => 'true'
      ]);
...
[💳] 𝘾𝙖𝙧𝙙 ϟ <code>$lista</code>
[〄] 𝙂𝘼𝙏𝙀𝙒𝘼𝙔  ϟ <code>$gate</code>
[〄] 𝙍𝙚𝙨𝙥𝙤𝙣𝙨𝙚 ϟ <code>$msg $rsppppp</code>
 <b>$avs</b>

[〄] 𝘽𝙞𝙣 𝙄𝙣𝙛𝙤 ϟ <code>$bininfo</code> 
[〄] 𝘽𝙖𝙣𝙠  ϟ <code>$bank</code>
[〄] 𝘾𝙤𝙪𝙣𝙩𝙧𝙮  ϟ <code>$country</code>

[〄] 𝙏𝙞𝙢𝙚  ϟ <code>$time Seconds</code>
$botu
",
        'parse_mode' => 'html',
        'disable_web_page_preview' => 'true'
